...
void UI_DrawDriverIconForDriver(int driverID, struct Icon *icon, s16 posX, s16 posY, struct PrimMem *primMem, uint32_t *ot, char transparency, s16 scale, u32 color);
void UI_DrawDriverIconDecalForDriver(int driverID, struct Icon *icon, s16 posX, s16 posY, struct PrimMem *primMem, uint32_t *ot, char transparency, s16 scale);
void UI_DrawDriverIconGT4ForDriver(int driverID, struct Icon *icon, s16 posX, s16 posY, struct PrimMem *primMem, uint32_t *ot, u32 color0, u32 color1, u32 color2, u32 color3, char transparency, s16 scale);
