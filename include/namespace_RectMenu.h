...
enum NativeMenuString
{
	...
	NATIVE_MENU_STRING_LOCAL_ARCADE = 0x7007,
	NATIVE_MENU_STRING_HOST_GAME = 0x7008,
	NATIVE_MENU_STRING_JOIN_GAME = 0x7009,
	NATIVE_MENU_STRING_CANCEL = 0x700a,
	NATIVE_MENU_STRING_ADHOC_STATUS = 0x700b,
};
#endif
