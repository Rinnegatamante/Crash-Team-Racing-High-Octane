...
enum NativeMenuString
{
	NATIVE_MENU_STRING_GHOST_REPLAY = 0x7000,
	NATIVE_MENU_STRING_MIRROR_MODE = 0x7001,
	NATIVE_MENU_STRING_SUPER_HARD = 0x7002,
	NATIVE_MENU_STRING_ULTRA_HARD = 0x7003,
	NATIVE_MENU_STRING_BOSS_FIGHT = 0x7004,
	NATIVE_MENU_STRING_OXIDE_FINAL = 0x7005,
	NATIVE_MENU_STRING_CHANGE_BOSS = 0x7006,
	NATIVE_MENU_STRING_ADHOC = 0x7007,
	NATIVE_MENU_STRING_FRAME_RATE = 0x7008,
	NATIVE_MENU_STRING_ONLINE_LEADERBOARD = 0x7009,
	NATIVE_MENU_STRING_WATCH_GHOST = 0x700a,
	NATIVE_MENU_STRING_BORDERLESS = 0x700b,
	NATIVE_MENU_STRING_ANTI_ALIASING = 0x700c,
	NATIVE_MENU_STRING_TRACK_NORMAL = 0x700d,
	NATIVE_MENU_STRING_TRACK_REVERSE = 0x700e,
	NATIVE_MENU_STRING_DEFAULT_CAMERA = 0x700f,
	NATIVE_MENU_STRING_DEFAULT_HUD = 0x7010,
	NATIVE_MENU_STRING_DITHERING = 0x7011,
	NATIVE_MENU_STRING_CONTROLS = 0x7012,
	NATIVE_MENU_STRING_CONTROL_HEADER = 0x7013,
	NATIVE_MENU_STRING_TRACK_ALTERNATIVE = 0x7014,
	NATIVE_MENU_STRING_CHEATS = 0x7030,
	NATIVE_MENU_STRING_CHEAT_WUMPA,
	NATIVE_MENU_STRING_CHEAT_MASK,
	NATIVE_MENU_STRING_CHEAT_TURBO,
	NATIVE_MENU_STRING_CHEAT_BOMBS,
	NATIVE_MENU_STRING_CHEAT_INVISIBLE,
	NATIVE_MENU_STRING_CHEAT_ENGINE,
	NATIVE_MENU_STRING_CHEAT_ICY,
	NATIVE_MENU_STRING_CHEAT_TURBOPAD,
	NATIVE_MENU_STRING_CHEAT_ADV,
	NATIVE_MENU_STRING_CHEAT_TURBOCOUNT,
	NATIVE_MENU_STRING_CONTROL_CROSS = 0x7020,
	NATIVE_MENU_STRING_CONTROL_SQUARE,
	NATIVE_MENU_STRING_CONTROL_CIRCLE,
	NATIVE_MENU_STRING_CONTROL_TRIANGLE,
	NATIVE_MENU_STRING_CONTROL_L1,
	NATIVE_MENU_STRING_CONTROL_R1,
	NATIVE_MENU_STRING_CONTROL_L2,
	NATIVE_MENU_STRING_CONTROL_R2,
	NATIVE_MENU_STRING_CONTROL_UP,
	NATIVE_MENU_STRING_CONTROL_DOWN,
	NATIVE_MENU_STRING_CONTROL_LEFT,
	NATIVE_MENU_STRING_CONTROL_RIGHT,
	NATIVE_MENU_STRING_CONTROL_START,
};
#endif
...
enum RectMenuDrawStyle
{
	...
	RECTMENU_DRAW_STYLE_NATIVE_OPTIONS = 0x400,
};
...
CTR_STATIC_ASSERT(RECTMENU_DRAW_STYLE_NATIVE_OPTIONS == 0x400);
